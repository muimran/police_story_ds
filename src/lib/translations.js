...
export const en = {
  ...
  policeMap: {
    scrollyTextboxes: {
        ...
        "7": "On the same day, then Prime Minister Sheikh Hasina approved the use of lethal weapons. In a phone conversation verified by The Daily Star, she was heard saying that the protesters should be 'shot wherever they are found'. About 100 protesters were killed across the country that day.",
  ...
  transfers: {
    scrollySteps: [
      { title: 'The Entire Group', description: 'During the July uprising, <span style="background-color: #9ca3af; color: white; padding: 2px 6px; border-radius: 4px; font-weight: 600;">365 officers</span> with the rank of Assistant Commissioner (AC) or higher were posted in the DMP area. Each dot represents one police officer.' },
      { title: '88% are forced out', description: 'Of these, 45 remain in their posts. The <span style="background-color: #663399; color: white; padding: 2px 6px; border-radius: 4px; font-weight: 600;">other 320</span> have either been transferred out, retired, or fled. The Daily Star acquired the transfer information of 236 senior officers.' },
      { title: 'A Split in Command', description: 'Among them, 64 were <span style="background-color: #fdba74; color: white; padding: 2px 6px; border-radius: 4px; font-weight: 600;">higher ranking</span> officials (Deputy Commissioner or above), while the <span style="background-color: #4E79A7; color: white; padding: 2px 6px; border-radius: 4px; font-weight: 600;">remaining 172</span> were ranked AC or ADC.' },
      ...
      { title: 'Attached Officers', description: 'xxxx xxxx xxxxx xxxx xxxxx xxxxx' },
      { title: 'The Final Picture', description: 'xxxx xxxx xxxxx xxxx xxxxx xxxxx' }
    ],
...
export const bn = {
  ...
  policeMap: {
    scrollyTextboxes: {
      ...
      "7": "একইদিনে তৎকালীন প্রধানমন্ত্রী শেখ হাসিনা ‘লিথাল' অস্ত্র অস্ত্র ব্যবহারের অনুমোদন দেন। দ্য ডেইলি স্টারের যাচাই করা একটি ফোনালাপে তাকে বলতে শোনা যায়, আন্দোলনকারীদের ‘যেখানেই পাবে, গুলি করবে'। সারাদেশে প্রায় ১০০ আন্দোলনকারী নিহত হয় সেদিন।",
  ...
  transfers: {
    scrollySteps: [
      { title: 'পুরো দলটি', description: 'জুলাই অভ্যুত্থানের সময়, सहायक কমিশনার (এসি) বা তদূর্ধ্ব পদের <span style="background-color: #9ca3af; color: white; padding: 2px 6px; border-radius: 4px; font-weight: 600;">৩৬৫ জন কর্মকর্তা</span> ডিএমপি এলাকায় কর্মরত ছিলেন। প্রতিটি ডট একজন পুলিশ কর্মকর্তাকে প্রতিনিধিত্ব করে।' },
      { title: '৮৮% বাধ্য হয়েছেন', description: 'এর মধ্যে ৪৫ জন তাদের পদে রয়েছেন। <span style="background-color: #663399; color: white; padding: 2px 6px; border-radius: 4px; font-weight: 600;">বাকি ৩২০ জন</span> হয় বদলি হয়েছেন, অবসর নিয়েছেন বা পালিয়েছেন। ডেইলি স্টার ২৩৬ জন সিনিয়র কর্মকর্তার বদলির তথ্য পেয়েছে।' },
      { title: 'কমান্ডে বিভাজন', description: 'তাদের মধ্যে ৬৪ জন ছিলেন <span style="background-color: #fdba74; color: white; padding: 2px 6px; border-radius: 4px; font-weight: 600;">উচ্চপদস্থ</span> কর্মকর্তা (ডেপুটি কমিশনার বা তদূর্ধ্ব), এবং <span style="background-color: #4E79A7; color: white; padding: 2px 6px; border-radius: 4px; font-weight: 600;">বাকি ১৭২ জন</span> ছিলেন এসি বা এডিসি পদের।' },
      { title: 'বদলির গন্তব্য', description: 'এই কর্মকর্তাদের ২১টি বিভিন্ন আউটপোস্টে পুনরায় নিয়োগ দেওয়া হয়েছে, যা আমরা পাঁচটি বিভাগে ভাগ করেছি। সিনিয়র কর্মকর্তাদের (ডিসি বা তদূর্ধ্ব) ৪৫% রেঞ্জ ডিআইজি-র অফিসে (কেন্দ্রীয় ও আঞ্চলিক প্রশাসন) বদলি হয়েছেন। সামগ্রিকভাবে সবচেয়ে বেশি বদলি হয়েছে বিশেষায়িত অপারেশনাল ইউনিট যেমন RAB এবং APBn-এ।' },
      { title: 'সংযুক্ত কর্মকর্তা', description: '[Attached Officers... এর বাংলা অনুবাদ]' },
      { title: 'চূড়ান্ত চিত্র', description: '[The Final Picture... এর বাংলা অনুবাদ]' }
    ],
